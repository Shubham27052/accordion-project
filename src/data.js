const data = [
  {
    qn: "Do I have to allow the use of cookes?",
  ...
  {
    qn: "How do I change my My Page password?",
  ...
  {
    qn: "Whose birth number can I use?",
  ...
  {
    qn: "When do I recieve a password ordered by letter?",
